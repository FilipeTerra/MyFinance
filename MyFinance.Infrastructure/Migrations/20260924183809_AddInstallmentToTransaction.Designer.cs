...
namespace MyFinance.Infrastructure.Migrations
{
    ...
    [Migration("20260924183809_AddInstallmentToTransaction")]
    partial class AddInstallmentToTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFinance.Domain.Entities.Investimento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyFinance.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("MyFinance.Domain.Entities.FinancialGoal", "FinancialGoal")
                        .WithMany()
                        .HasForeignKey("FinancialGoalId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MyFinance.Domain.Entities.Investimento", "Investimento")
                        .WithMany()
                        .HasForeignKey("InvestimentoId")
                        .OnDelete(DeleteBehavior.SetNull);
